...
type
  ...
  private
    ...
    idbd, nomebd, idcursobd, turnobd, periodobd,idcursobdComboBox, cursobd: string;
    datanascimentobd, dataingressofaculdadebd: TDateTime;
  public
    { Public declarations }
  var
    //idcursobdComboBox: integer;
  end;
...
begin
  ...
  ComboBoxCursos1.chooseIndex(idcursobd);
end;
...
begin
  ...
  idcursobdComboBox := FDQuery3.FieldByName('idcurso').AsString;
    ComboBoxCursos1.addMega(FDQuery3.Fields[1].AsString,
      (idcursobdComboBox));
    FDQuery3.Next;
  end;
  FDQuery3.Close;
